...
describe("UCSBDiningCommonsMenuItemCreatePage tests", () => {
    ...
    test("on submit, makes request to backend, and redirects to /ucsbdiningcommonsmenuitem", async () => {
        ...
        fireEvent.change(diningCommonsCodeInput, { target: { value: 'Portolla' } })
        fireEvent.change(nameInput, { target: { value: 'Cream of Broccoli Soup (v)' } })
        fireEvent.change(stationInput, { target: { value: 'Greens & Grains' } })
        ...
        expect(mockToast).toBeCalledWith("New dining commons menu item Created - id: 3 name: Cream of Broccoli Soup (v)");
