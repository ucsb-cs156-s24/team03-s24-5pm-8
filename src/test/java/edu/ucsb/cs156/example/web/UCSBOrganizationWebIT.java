...
public class UCSBOrganizationWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_organization() throws Exception {
        ...
        page.getByTestId("UCSBOrganizationForm-orgCode").fill("SPE");
        page.getByTestId("UCSBOrganizationForm-orgTranslationShort").fill("SigEp");
        page.getByTestId("UCSBOrganizationForm-orgTranslation").fill("SigmaPhiEpsilon");
        ...
        page.getByTestId("UCSBOrganizationForm-orgTranslationShort").fill("TheEps");
        page.getByTestId("UCSBOrganizationForm-inactive").fill("false");
        page.getByTestId("UCSBOrganizationForm-submit").click();

        assertThat(page.getByTestId("USCBOrganizationTable-cell-row-0-col-orgTranslationShort")).hasText("TheEps");
